...
CREATE TABLE `exam_items`  (
  ...
  `embranchment` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '分支机构',
...
INSERT INTO `exam_items` VALUES (101, '删除）', 'TJXM2OO5mT', 0, '男性项目', 120000, 88000, '北京', NULL, 1, '1', 'aaaa', '教师', '撒大声地', 0, 1617272059);
